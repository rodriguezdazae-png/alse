...
// ✅ Función que implementa las operaciones solicitadas
...
int main(int argc, char* argv[]) {
    ...
    try {
        // ✅ Conversión de argumentos (permite decimales con stof)
        float num1 = stof(argv[1]);  
        string op = argv[2];  
        float num2 = stof(argv[3]);  

        // ✅ Llamada a la función de operación
        ...
        // ✅ Manejo de errores por digitación incorrecta
